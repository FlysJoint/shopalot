const recipes = {
    ...
    "Broccoli & Stilton soup": [
        ['lunch', 4, 'english'],
        ["olive oil", 0.166, 'condiments', 'tbsp'],
        ['onion', 1, 'veg', 'whole'],
    ...
    'French Dressing': [
        ...
        ['extra virgin olive oil', 90, 'condiments', 'ml'],
    ...
    'Italian Dressing': [
        ...
        ['extra virgin olive oil', 125, 'condiments', 'ml'],
        ['honey', 1, 'baking', 'tbsp'],
        ['salt', 0.5, 'spices', 'tsp'],
        ['black pepper', 0.25, 'spices', 'tsp'],
    ...
    'Lemon Dressing': [
        ...
        ['extra virgin olive oil', 187.5, 'condiments', 'ml'],
